...
public class GlobalExceptionHandler {
  ...
  private HttpStatus parseHttpStatus(ErrorCode errorCode) {
    return switch (errorCode) {
      ...
      case USER_ALREADY_EXISTS, INTEREST_ALREADY_EXISTS, ALREADY_SUBSCRIBED,
           ALREADY_LIKED_COMMENT, ARTICLE_ALREADY_DELETED, COMMENT_ALREADY_DELETED,
           DATA_CONFLICT -> HttpStatus.CONFLICT;

      case INVALID_CREDENTIALS -> HttpStatus.UNAUTHORIZED;

      case NOTIFICATION_ACCESS_DENIED, COMMENT_ACCESS_DENIED -> HttpStatus.FORBIDDEN;

      case INVALID_REQUEST, VALIDATION_ERROR, TYPE_MISMATCH,
           ARTICLE_NOT_DELETED, COMMENT_LIKE_NOT_FOUND -> HttpStatus.BAD_REQUEST;
